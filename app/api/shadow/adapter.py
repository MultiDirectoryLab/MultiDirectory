...
class ShadowAdapter(BaseAdapter):
    ...
    def __init__(self, mfa_manager: MFAManager, auth_manager: AuthManager) -> None:
    ...
    async def change_password(self, principal: str, new_password: str) -> None:
        ...
        return await self._auth_manager.sync_password_from_service(principal, new_password)
