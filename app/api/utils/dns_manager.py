...
class DNSManager:
    ...
    Uses CoreDNSManager from ldap_protocol for low-level operations.
    """
    ...
    def __init__(self, session: AsyncSession, settings: Settings) -> None:
        ...
        self._core_manager: CoreDNSManager | None = None

    async def _get_core_manager(self) -> CoreDNSManager:
        """Get an instance of CoreDNSManager with up-to-date settings.
        ...
        if (
            ...
            self._core_manager = CoreDNSManager(dns_settings)
