...
users_table = Table(
    ...
    Column("accountExpires", DateTime(timezone=True), key="account_expires"),
    Column(
        "password_history",
        ARRAY(String),
        server_default="{}",
...
class Group:
    ...
    users: list[User] = field(init=False, default_factory=list, repr=False)
    roles: list[Role] = field(init=False, default_factory=list, repr=False)
    search_fields: ClassVar[dict[str, str]] = {}
