...
def upgrade(container: AsyncContainer) -> None:
    """Upgrade."""
    op.add_column("Policies", sa.Column("ldap_session_ttl", sa.Integer(), server_default="-1", nullable=False))
    op.add_column("Policies", sa.Column("http_session_ttl", sa.Integer(), server_default="28800", nullable=False))
