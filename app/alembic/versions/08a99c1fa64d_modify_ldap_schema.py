...
Revision ID: 08a99c1fa64d
Revises: 275222846605
Create Date: 2025-04-28 19:06:48.313283
...
def upgrade() -> None:
    ...
    async def _create_attribute_types(connection):
        ...
        # It takes from https://github.com/krb5/krb5/blob/master/src/plugins/kdb/ldap/libkdb_ldap/kerberos.schema
        attribute_type_raws = [
        ...
        for _attribute_type_raw in attribute_type_raws:
            attribute_type = RDParser.create_attribute_type_by_raw(
                raw_definition=_attribute_type_raw
            )
    ...
    async def _create_object_classes(connection):
        ...
        for _object_class_raw in object_class_raws:
            object_class_info = RDParser.get_object_class_info(
                raw_definition=_object_class_raw
            )
