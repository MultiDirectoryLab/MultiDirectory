...
def upgrade() -> None:
    ...
    op.add_column(
        "PasswordPolicies",
        sa.Column("min_lowercase_letters_count", sa.Integer(), nullable=False),
    )
    op.add_column(
        "PasswordPolicies",
        sa.Column("min_uppercase_letters_count", sa.Integer(), nullable=False),
    )
    op.add_column(
        "PasswordPolicies",
        sa.Column("min_special_symbols_count", sa.Integer(), nullable=False),
    )
    op.add_column(
        "PasswordPolicies",
        sa.Column("min_digits_count", sa.Integer(), nullable=False),
    )
    op.add_column(
        "PasswordPolicies",
        sa.Column("min_unique_symbols_count", sa.Integer(), nullable=False),
    )
    op.add_column(
        "PasswordPolicies",
        sa.Column(
    ...
    op.add_column(
        "PasswordPolicies",
        sa.Column("failed_attempts_reset_sec", sa.Integer(), nullable=False),
    )
    op.add_column(
        "PasswordPolicies",
        sa.Column("lockout_duration_sec", sa.Integer(), nullable=False),
    )
    op.add_column(
        "PasswordPolicies",
        sa.Column("fail_delay_sec", sa.Integer(), nullable=False),
    )
    op.drop_constraint(
