...
class StubDHCPAPIRepository(DHCPAPIRepository):
    ...
    @logger_wraps(is_stub=True)
    async def get_subnet_by_id(self, subnet_id: int) -> NoReturn:  # noqa: ARG002
        raise DHCPAPIError
    ...
    @logger_wraps(is_stub=True)
    async def list_leases_by_subnet_id(self, subnet_ids: list[int]) -> NoReturn:  # noqa: ARG002
        raise DHCPAPIError

    @logger_wraps(is_stub=True)
    async def get_lease_by_hw_address(self, hw_address: str) -> NoReturn:  # noqa: ARG002
        raise DHCPAPIError

    @logger_wraps(is_stub=True)
    async def get_lease_by_hostname(self, hostname: str) -> NoReturn:  # noqa: ARG002
        raise DHCPAPIError
    ...
    @logger_wraps(is_stub=True)
    async def list_reservations(self, subnet_id: int) -> NoReturn:  # noqa: ARG002
        raise DHCPAPIError
...
class StubDHCPManager(AbstractDHCPManager):
    ...
    @logger_wraps(is_stub=True)
    async def get_subnets(self) -> NoReturn:
        raise DHCPAPIError
    ...
    @logger_wraps(is_stub=True)
    async def list_active_leases(self, subnet_id: int) -> NoReturn:  # noqa: ARG002
        raise DHCPAPIError

    @logger_wraps(is_stub=True)
    async def find_lease(self, mac_address: str | None = None, hostname: str | None = None) -> NoReturn:  # noqa: ARG002
        raise DHCPAPIError
    ...
    @logger_wraps(is_stub=True)
    async def get_reservations(self, subnet_id: int) -> NoReturn:  # noqa: ARG002
        raise DHCPAPIError
