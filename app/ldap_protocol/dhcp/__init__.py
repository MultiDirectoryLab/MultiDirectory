...
def get_dhcp_manager_class(dhcp_state: DHCPManagerState) -> type[AbstractDHCPManager]:
...
def get_dhcp_api_repository_class(dhcp_state: DHCPManagerState) -> type[DHCPAPIRepository]:
