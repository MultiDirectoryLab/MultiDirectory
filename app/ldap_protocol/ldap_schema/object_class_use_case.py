...
class ObjectClassUseCase(AbstractService):
    ...
    PERMISSIONS: ClassVar[dict[str, AuthoruzationRules]] = {
        get.__name__: AuthoruzationRules.OBJECT_CLASS_GET,
        create.__name__: AuthoruzationRules.OBJECT_CLASS_CREATE,
        get_paginator.__name__: AuthoruzationRules.OBJECT_CLASS_GET_PAGINATOR,
        update.__name__: AuthoruzationRules.OBJECT_CLASS_UPDATE,
        delete_all_by_names.__name__: AuthoruzationRules.OBJECT_CLASS_DELETE_ALL_BY_NAMES,  # noqa: E501
    }
