...
class DataLogger:
    ...
    def __init__(self, logger: _LoggingProtocol, is_full: bool = False, prefix: str = "") -> None:
        """Set logging mode."""
        self._l = logger
        self._prfx = prefix
        if is_full:
