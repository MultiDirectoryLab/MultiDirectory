...
DNS_FIRST_SETUP_RECORDS: list[dict[str, str | DNSRecordType]] = [
    ...
    {"name": "_ldap._tcp.pdc._msdcs.", "value": "0 100 389 ", "type": DNSRecordType.SRV},
    # Records for DC Locator (for trusts)
    {"name": "_kerberos._tcp.dc._msdcs.", "value": "0 100 88 ", "type": DNSRecordType.SRV},
    {
        "name": "_kerberos._tcp.Default-First-Site-Name._sites.dc._msdcs.",
        "value": "0 100 88 ",
        "type": DNSRecordType.SRV,
    },
    {"name": "_ldap._tcp.dc._msdcs.", "value": "0 100 389 ", "type": DNSRecordType.SRV},
    {"name": "_ldap._tcp.Default-First-Site-Name._sites.dc._msdcs.", "value": "0 100 389 ", "type": DNSRecordType.SRV},
    # Records for Global Catalog
    {"name": "_gc._tcp.", "value": "0 100 3268 ", "type": DNSRecordType.SRV},
    {"name": "_ldap._tcp.Default-First-Site-Name._sites.gc._msdcs.", "value": "0 100 3268 ", "type": DNSRecordType.SRV},
    {"name": "_ldap._tcp.gc._msdcs.", "value": "0 100 3268 ", "type": DNSRecordType.SRV},
]
