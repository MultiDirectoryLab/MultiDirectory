...
from ldap_protocol.dns.dto import DNSForwardZoneDTO, DNSMasterZoneDTO, DNSRRSetDTO, DNSSettingsDTO
...
class StubDNSManager(AbstractDNSManager):
    ...
    @logger_wraps(is_stub=True)
    async def get_records(self, zone_id: str) -> list[DNSRRSetDTO]:  # noqa: ARG002
        return []
