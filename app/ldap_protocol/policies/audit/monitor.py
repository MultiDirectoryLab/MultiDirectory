...
class AuditMonitorUseCase:
    ...
    def _wrap_callback_mfa(self, attr: Callable) -> object:
        @wraps(attr)
    ...
    def _wrap_proxy_request(self, attr: Callable) -> object:
        @wraps(attr)
    ...
    def _wrap_login(self, attr: Callable) -> object:
        @wraps(attr)
    ...
    def _wrap_change_password(self, attr: Callable) -> object:
        @wraps(attr)
    ...
    def _wrap_reset_password(self, attr: Callable) -> object:
        @wraps(attr)
