...
from application.objects import DerefAliases, ProtocolRequests, Scope
from application.roles.access_manager import AccessManager
from application.rootdse.netlogon import NetLogonAttributeHandler
from application.utils.cte import get_all_parent_group_directories
