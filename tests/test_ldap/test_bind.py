...
async def test_gssapi_bind_in_progress(
    ...
    async def mock_init_security_context(
        session: AsyncSession,  # noqa: ARG001 NOTE: _init_security_context's signature needs it
        settings: Settings,  # noqa: ARG001 NOTE: _init_security_context's signature needs it
    ) -> None:
